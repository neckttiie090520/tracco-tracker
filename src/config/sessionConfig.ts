...
export const sessionConfig = {
  ...
  maxIdleTime: parseInt(import.meta.env.VITE_SESSION_IDLE_TIME || '3600000'), // 60 * 60 * 1000
  
  // Total session timeout (default: 8 hours)
  sessionTimeout: parseInt(import.meta.env.VITE_SESSION_TIMEOUT || '28800000'), // 8 * 60 * 60 * 1000
  
  // Time before timeout to show warning (default: 5 minutes)
  warningTime: parseInt(import.meta.env.VITE_SESSION_WARNING_TIME || '300000'), // 5 * 60 * 1000
  
  // Enable/disable session management (default: enabled)
  enabled: import.meta.env.VITE_SESSION_MANAGEMENT_ENABLED !== 'false',
}
