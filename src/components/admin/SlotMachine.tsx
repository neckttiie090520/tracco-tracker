...
export function SlotMachine({ participants, sessionTitle }: SlotMachineProps) {
  ...
  const spin = async () => {
    ...
    try {
      ...
      const finalPosition = -(spinningNames.length - 1) * 120 // 120px per item
  ...
  return (
    <div className="relative">
      ...
      {/* Slot Machine */}
      <div className="slot-machine bg-gradient-to-b from-gray-200 to-gray-300 rounded-3xl p-8 shadow-2xl border-4 border-gray-400">
        {/* Title */}
        ...
        {/* Slot Window */}
        <div className="slot-window bg-black rounded-2xl p-4 mb-6 relative overflow-hidden">
          <div className="slot-inner bg-gradient-to-b from-gray-800 to-gray-900 rounded-xl h-32 relative overflow-hidden">
            {/* Reel Container */}
            <div 
              ref={reelRef}
            ...
            <div className="absolute inset-0 pointer-events-none">
              ...
              <div className="absolute top-1/2 left-0 right-0 transform -translate-y-1/2 h-16 border-t-2 border-b-2 border-gray-400"></div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center space-y-4">
          <button
            ...
            className={`
              px-8 py-4 rounded-2xl font-bold text-xl transition-all duration-200 shadow-lg
        ...
        {/* Winner Display */}
        {winner && (
          <div className="mt-6 p-6 bg-white bg-opacity-90 backdrop-blur-sm rounded-2xl border-2 border-gray-400">
